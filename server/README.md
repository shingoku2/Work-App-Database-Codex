...
- revoke helper: `/usr/lib/antminer-fleet-server/revoke-client-tunnel-key.sh`
...
Full step-by-step guide: [../docs/ssh-tunnel-onboarding.md](../docs/ssh-tunnel-onboarding.md)
